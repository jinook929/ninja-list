...
Open [http://localhost:4000](http://localhost:4000) with your browser to see the result (for port, see `"scripts"` in `package.json`).
...
## Deployed on Vercel ([Live Demo](https://ninja-list-jinook.vercel.app/))
